...
SUPABASE_URL = "https://ylklvmejsdhjibpctgta.supabase.co/"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlsa2x2bWVqc2RoamlicGN0Z3RhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2ODI5NDI0MSwiZXhwIjoyMDgzODcwMjQxfQ.wT_VYEw0NcvLNeiQATm7y5LgnEB03Y7O5LqJAooCsSE" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES2UG23AM094.png"  # Replace with the local image path
image_name = "AI.png"  # Desired name for the uploaded file
